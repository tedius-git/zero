...
var $author$project$Main$GetSvgSize = {$: 'GetSvgSize'};
var $author$project$Parse$Point = function (a) {
	return {$: 'Point', a: a};
};
var $author$project$Parse$Vector = function (a) {
	return {$: 'Vector', a: a};
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		...
		A2(
			$elm$core$Task$perform,
			function (_v1) {
				return $author$project$Main$GetSvgSize;
			},
...
var $author$project$Main$GotSvgSize = function (a) {
	return {$: 'GotSvgSize', a: a};
};
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$areDifferentPoint = F2(
	function (_v0, _v1) {
		var p1 = _v0.a;
		var p2 = _v1.a;
		return !_Utils_eq(p1.name, p2.name);
	});
var $author$project$Main$areDifferentVector = F2(
	function (_v0, _v1) {
		var v1 = _v0.a;
		var v2 = _v1.a;
...
var $author$project$Parse$problemToString = function (p) {
	switch (p.$) {
		case 'Expecting':
			var s = p.a;
			return 'expecting \'' + (s + '\'');
...
var $author$project$Parse$deadEndToString = function (deadend) {
	return $author$project$Parse$problemToString(deadend.problem) + (' at row ' + ($elm$core$String$fromInt(deadend.row) + (', col ' + $elm$core$String$fromInt(deadend.col))));
};
...
var $author$project$Parse$deadEndsToString = function (deadEnds) {
	return $elm$core$String$concat(
		A2(
			$elm$core$List$intersperse,
			'; ',
			A2($elm$core$List$map, $author$project$Parse$deadEndToString, deadEnds)));
};
...
var $author$project$Parse$signFloat = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Parse$parseCoords = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		...
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				A2($elm$parser$Parser$ignorer, $author$project$Parse$signFloat, $elm$parser$Parser$spaces),
				$elm$parser$Parser$symbol(',')),
			$elm$parser$Parser$spaces)),
	$author$project$Parse$signFloat);
var $author$project$Parse$named2DParser = F4(
	function (nameParser, leftDelim, rightDelim, wrap) {
		return A2(
			$elm$parser$Parser$keeper,
			A2(
				$elm$parser$Parser$keeper,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$parser$Parser$ignorer,
								A2($elm$parser$Parser$ignorer, nameParser, $elm$parser$Parser$spaces),
								$elm$parser$Parser$symbol('=')),
							$elm$parser$Parser$spaces),
						$elm$parser$Parser$symbol(leftDelim)),
					$elm$parser$Parser$spaces)),
			A2(
				$elm$parser$Parser$ignorer,
				A2($elm$parser$Parser$ignorer, $author$project$Parse$parseCoords, $elm$parser$Parser$spaces),
				$elm$parser$Parser$symbol(rightDelim)));
	});
...
var $author$project$Parse$pointName = $elm$parser$Parser$variable(
	{inner: $elm$core$Char$isDigit, reserved: $elm$core$Set$empty, start: $elm$core$Char$isUpper});
var $author$project$Parse$point = A4($author$project$Parse$named2DParser, $author$project$Parse$pointName, '(', ')', $author$project$Parse$Point);
var $author$project$Parse$vectorName = $elm$parser$Parser$variable(
	{inner: $elm$core$Char$isDigit, reserved: $elm$core$Set$empty, start: $elm$core$Char$isLower});
var $author$project$Parse$vector = A4($author$project$Parse$named2DParser, $author$project$Parse$vectorName, '<', '>', $author$project$Parse$Vector);
var $author$project$Main$parserMaster = function (model) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				function (p) {
					return A2($elm$core$List$member, p, model.points) ? _Utils_update(
						model,
						{parseError: 'Duplicate Point'}) : _Utils_update(
						model,
						{
							inputText: '',
				...
				$elm$parser$Parser$map,
				function (v) {
					return A2($elm$core$List$member, v, model.vectors) ? _Utils_update(
						model,
						{parseError: 'Duplicate Vector'}) : _Utils_update(
						model,
						{
							inputText: '',
							vectors: A2($elm$core$List$cons, v, model.vectors)
						});
				},
				$author$project$Parse$vector)
			]));
			...
			case 'Add':
				if (model.inputText !== '') {
					var _v1 = A2(
						...
						$author$project$Main$parserMaster(model),
						model.inputText);
					if (_v1.$ === 'Ok') {
						var newModel = _v1.a;
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									parseError: $author$project$Parse$deadEndsToString(err)
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
					...
					_Utils_update(
						model,
						{
							points: A2(
								...
								$author$project$Main$areDifferentPoint(pointToDelete),
								model.points)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DeleteVector':
				var vectorToDelete = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							vectors: A2(
								$elm$core$List$filter,
								$author$project$Main$areDifferentVector(vectorToDelete),
								model.vectors)
						}),
					$elm$core$Platform$Cmd$none);
			case 'GetSvgSize':
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Main$GotSvgSize,
						$elm$browser$Browser$Dom$getElement('graph')));
			default:
				if (msg.a.$ === 'Ok') {
					var element = msg.a.a;
					return _Utils_Tuple2(
...
var $author$project$Main$errorToDiv = function (error) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Draw$arrowMarker = A2(
	$elm$svg$Svg$defs,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$points('0 0, 10 3.5, 0 7'),
...
var $author$project$Draw$axis = F2(
	function (svgHeight, svgWidth) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$class('axes')
				]),
			_List_fromArray(
				[
					A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(svgY)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$class('points')
						]),
					A2(
						$elm$core$List$map,
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$class('vectors')
						]),
					A2(
						$elm$core$List$map,
...
var $author$project$Parse$pointToString = function (_v0) {
	var p = _v0.a;
	return p.name + (': ' + ('(' + ($elm$core$String$fromFloat(p.x) + (',' + ($elm$core$String$fromFloat(p.y) + ')')))));
};
var $author$project$Main$pointToDiv = function (point) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('entry-text')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Parse$pointToString(point))
					])),
				A2(
...
var $author$project$Parse$vectorToString = function (_v0) {
	var v = _v0.a;
	return v.name + (': ' + ('<' + ($elm$core$String$fromFloat(v.x) + (',' + ($elm$core$String$fromFloat(v.y) + '>')))));
};
var $author$project$Main$vectorToDiv = function (vector) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Parse$vectorToString(vector))
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
...
var $author$project$Main$viewInput = function (inputText) {
	return A2(
		$elm$html$Html$form,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('add-input'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewInput(model.inputText),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$author$project$Main$errorToDiv(model.parseError)
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						$elm$core$List$reverse(
							A2($elm$core$List$map, $author$project$Main$pointToDiv, model.points))),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						$elm$core$List$reverse(
					...
					[
						...
						if (_v0.$ === 'Just') {
							...
							return A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Error trying to get svg size')
									]));
						}
					}()
					]))
